...
<figure markdown>
<a href = 'KYA212__Entropy.pdf'> <i class="fas fa-file-pdf fa-3x"></i> </a>
...
<figure style="text-align: center;">
  <video controls style="max-width: 75%; height: auto;">
    <source src="nails.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
  <figcaption style="margin-top: 0.5em;">Breaking the universe? The original source for this video can be found <a href = 'https://imgur.com/nails-ebA4q0p'>here</a>.</figcaption>
</figure>
